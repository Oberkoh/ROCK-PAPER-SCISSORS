...
class Player:
    ...
    # Method to learn opponent's move
    def learn(self, player_one_move):
        pass

    # Method to check if user move beat opponent's move
...
class HumanPlayer(Player):
    ...
    # Method to learn the move of opponent player
...
class Game:
    ...
    def displayWinner(self):
        # Additional code to make it stand out by adding terminal Colors
        ...
        if self.p1.score > self.p2.score:
            ...
            printRed("THE GAME ENDED IN A DRAW")
...
if __name__ == '__main__':
    ...
    while True:
        try:
            # ASk for the number of rounds and converts to int
